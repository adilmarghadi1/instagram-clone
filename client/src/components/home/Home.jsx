...
import img21 from '../../images/im21.jfif'
...
tiffintech</span> Monday vibes! Which mood are you today?!
        ...
        <div className='box4'>
          <div className='top'>
                ...
                <img src={img21} className='img2' alt='img' />
              <div className='bottom1'>
                <div className='left1'>
            ...
            <h2>6,352 likes</h2>
            <h3><span className='big'>
adil.dev1</span> The Only Way Is Up  💡
        ...
        <div className='box4'>
          <div className='top'>
                    <img src={img23} alt='profile' />
                    <p>billieeilish
</p> 
                <BiDotsHorizontalRounded className='dots'/>
                </div>
                <img src={img24} className='img2' alt='img' />
              <div className='bottom1'>
                <div className='left1'>
            ...
            <h3><span className='big'>
            billieeilish
</span> TOUR’S BEEN A DREEEAAAMMMMMMM ✨🥰
